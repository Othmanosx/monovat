const blog_data = [
  {
    ...
    comment: "10",
    views: "1,326",
    href: "https://www.instagram.com/p/CnCzz9LNWr3/",
    title: "شنو هي مونوڤات؟",
    short_desc:
      " نحن شركة ناشئة نساعد في تنمية وتطوير مختبرات صناعة الاسنان عن طريق تقنية الطباعة ثلاثية الابعاد، حيث نوفر طابعات ثلاثية الابعاد، مواد طباعة ثلاثية الابعاد خاصة بصناعة الاسنان، تدريبات للمختصين، صيانة وتشغيل الطابعات ثلاثية الابعاد، أيضا نوفر خدمات طباعة ثلاثية الابعاد بمجال صناعة الاسنان تابعونا بتفاصيل أكثر عن منتجاتنا وخدماتنا بالمنشورات القادمة وشاركوا صفحتنا مع المختصين بمجال الاسنان",
    duration: ".6s",
    delay: ".4s",
    home: true,
  },
  {
    ...
    date: "January. 7.2023",
    author: "Mamun",
    href: "https://www.instagram.com/p/CnH0PaTq3Hc/",
    comment: "09",
    views: "2,226",
    title: "شنو هي خدماتنا؟",
    short_desc:
      "بعد ما تعرفتم على مونوفات والمنتجات الي تقدمها هسا خلونا نتعرف شنو الخدمات الي توفرها مونوفات لعملائها؟ احفظوا شاركوا المنشور مع تقنيين، أطباء، ممارسين، مختبرات الاسنان واي شخص مهتم بهذا المجال",
    duration: ".7s",
    delay: ".6s",
    home: true,
  },
  {
    ...
    comment: "21",
    views: "1,426",
    href: "https://www.instagram.com/p/CnFUSp2qXfH/",
    title: "شنو هي منتجاتنا؟",
    short_desc:
      " بعد ما تعرفتم على مونوفات هسا خلونا نتعرف شنو المنتجات الي تقدمها مونوفات؟ احفظوا شاركوا المنشور مع تقنيين، أطباء، ممارسين، مختبرات الاسنان واي شخص مهتم بهذا المجال مونوفات هيا شركة ناشئة مختصة بتطوير وتنمية قطاع تعويضات الاسنان عن طريق تقنية الطباعة ثلاثية الابعاد تابعونا على منصة الفيسبوك والانستكرام أيضا تحياتنا ",
    duration: ".3s",
    delay: ".5s",
    home: true,
  },
